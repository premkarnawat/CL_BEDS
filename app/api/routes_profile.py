...
async def update_profile(
    ...
    if payload.avatar_url is not None: updates["avatar_url"] = payload.avatar_url
    ...
    updates["now"] = datetime.now(tz=timezone.utc)
...
async def delete_account(
    ...
    logger.info("User %s deleted their own account", current_user.sub)
    return None
