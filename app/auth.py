...
Compatible with both calling conventions:
  create_access_token(user_id, email, role)          # old style
  create_access_token(subject=x, extra_claims={...}) # routes_auth style
"""
import time
...
def create_access_token(
    ...
    *,
    ...
    role = (extra_claims or {}).get("role", role)
    now = int(time.time())
    payload = {
